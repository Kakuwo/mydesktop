...
echo "Bem-vindo ao seu mais novo sistema operacional" ;

echo "O script automatizado para total imersão"

### - Atualização de repósitórios - ###

sudo apt update ;

### - Atualização do sistema em geral - ###

sudo apt upgrade -y ; sudo apt dist-upgrade -y ;

### - Instalação de pacotes essenciais para o script - ###

sudo apt install git curl wget snapd flatpak gedit -y ;
...
sudo apt dpkg -i discord-0.0.10.deb ;

sudo apt install -f -y ;

#> MEGA

wget -c https://mega.nz/linux/MEGAsync/Debian_10.0/amd64/megacmd-Debian_10.0_amd64.deb ;

wget -c https://mega.nz/linux/MEGAsync/Debian_10.0/amd64/megasync-Debian_10.0_amd64.deb ;

sudo dpkg -i megacmd-Debian_10.0_amd64.deb ;
